...
// TODO DOC remove deprectecated frameBorder: '0' and scrolling: 'no', remove resizable property (only for AMP)
export const Iframe = memo(function IframeComponent({
  ...
  if (layout === IFRAME_LAYOUT.RESPONSIVE) {
    style = Object.assign(
      style,
      {
        width: '100%',
...
// export class Iframe extends PureComponent {
